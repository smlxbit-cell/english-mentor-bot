...
def format_subscription_compact(
    ...
    *,
    ...
    """Понятные тарифы на русском — без абстрактных Basic/Active."""
    tier_note = {
        'free': 'сейчас: бесплатный тариф',
    ...
    lines = [
        ...
        '',
        '🆓 <b>Бесплатно</b> — 0 ₽ навсегда\n'
        '• эпизоды 1–3 сериала\n'
        '• словарь и карта грамматики\n'
        '• озвучка 🔊 всего английского\n'
        '• наставник — <b>текстом</b> (лимит в месяц)\n'
        '• <i>без голосового ввода 🎙️</i>',
        '',
        '<b>Платные</b> — 30 дней, без автопродления.\n'
        'В каждом — <b>вся программа</b> + минуты <b>голосового наставника</b> '
        '(говоришь боту — он отвечает голосом):',
        '• <b>Базовый</b> 590 ₽ — ~60 мин/мес (~2 мин/день)',
        '• <b>Активный</b> 990 ₽ — ~180 мин/мес (~6 мин/день)',
        '• <b>Про</b> 1990 ₽ — ~450 мин/мес (интенсив)',
        '',
        '➕ <b>+100 мин голоса</b> — 290 ₽, докупка при активной подписке.',
    ]
